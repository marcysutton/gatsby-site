                        ...
                        <div role="form" lang="en-US" dir="ltr">
                            ...
                            <form disabled key="contact-form" action="/thanks/" name="contact" method="POST" data-netlify="true" data-netlify-honeypot="pooh-field">
                                ...
                                <p>
                                    ...
                                    <input disabled type="text" name="name" size="40" id="name" required="true" />
                                </p>
                                <p>
                                    <label htmlFor="email">Your Email</label><br />
                                    <input disabled type="email" name="email" size="40" id="email" required="true" />
                                </p>
                                <p>
                                    <label htmlFor="subject">Your Subject</label><br />
                                    <input disabled type="text" name="subject" size="40" id="subject" required="true" />
                                </p>
                                <p>
                                    <label htmlFor="message">Your Message</label><br />
                                    <textarea disabled name="message" cols="40" rows="10" id="message" required="true"></textarea>
                                </p>
                                <p><input disabled type="submit" value="Send" /></p>
                                <input disabled type="hidden" name="form-name" value="contact" />
                            </form>
                        </div>
                    </div>
                </section>
