                ...
                <Layout>
                    ...
                    <div className="generic-wrap page-post-wrap">
                        ...
                        <aside className="page-post-aside breathing-room">
                            ...
                            <ul>
                                <li>Smashing Magazine workshop: <a href="https://smashingconf.com/online-workshops/workshops/marcy-sutton-nov">Frontend Accessibility Masterclass</a>.<br /><strong>Starts Nov. 6-7, 2020! (Sold Out)</strong></li>
                                <li>Frontend Masters video course: <a href="https://frontendmasters.com/courses/javascript-accessibility/">Accessibility in JavaScript Applications</a></li>
                                <li>Egghead video course: <a href="https://egghead.io/courses/start-building-accessible-web-applications-today">Start Building Accessible Web Applications Today</a></li>
                                <li>Accessibility chapter in <a href="https://www.smashingmagazine.com/2018/09/smashing-book-6-release/">Smashing Book 6: New Frontiers in Web Design</a></li>
                            ...
                            <ul>
                                ...
                                <li><a href="https://www.gatsbyjs.com/blog/2019-07-11-user-testing-accessible-client-routing/">User testing of accessible client-side routing techniques with Fable Tech Labs (Gatsby blog)</a></li>
                            </ul>
                        </aside>
                    </div>
                </Layout>
