                ...
                <Layout>
                    ...
                    <div className="generic-wrap page-post-wrap">
                        <section className="page-post-detail">
                            ...
                            <p><strong>At this time (Oct. 2024), I’m working full-time as a software engineer.</strong> While I’m no longer doing consulting projects, you can still hire me using <a href="https://superpeer.com/marcysutton">Superpeer</a>, a service for 1:1 calls.</p>
                            <h2>Marcy’s Bio</h2>
                            <p><em>(See <a href="#bio-short-version">bonus short version, below</a>)</em></p>
                            <p>I recently joined the nonprofit <a href="https://khanacademy.com">Khan Academy</a> as a Senior Engineer on the Frontend Infrastructure team. I'm thrilled to be working on React design systems and accessibility for a platform with such a big impact!</p>
                            <p>In October 2023, I started a new role as a senior front-end developer at <a href="https://principlestudios.com">Principle Studios</a>, a remote digital agency with a strong engineering team and a fantastic culture. I was overjoyed to build websites again, growing the engineering skills and career I want to have. Principle was acquired in March 2024 by Shift Paradigm, a marketing tech firm. I led the front end on an Adobe Experience Manager project before leaving the company for my new role.</p>
                            <p>In 2022, I launched an online workshop series <a href='https://testingaccessibility.com'>testingaccessibility.com</a> with the folks over at <a href="https://egghead.io">Egghead.io</a>. I spent a great few years as an independent accessibility engineering consultant and trainer, working with tech organizations such as Spotify, Microsoft, Google, Pinterest, T-Mobile, Change.org, Evinced, and more.</p>
